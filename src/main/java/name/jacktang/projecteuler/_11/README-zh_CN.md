...
## [矩阵中相邻数的最大乘积](https://projecteuler.net/problem=11)

在下面 20×20 的矩阵中，对角线上标记了 4 个数。
...
这 4 个数的乘积是 $26 × 63 × 78 × 14 = 1788696$。

求上面 20×20 的矩阵中在同一方向上相邻 4 个数的最大乘积（行、列和对角线）。
...
只需依次计算行、列、左对角线和右对角线上的 4 个相邻数的乘积即可。需要注意的是，行和列上的循环次数为 20×17，而对角线上则是 17×17。
